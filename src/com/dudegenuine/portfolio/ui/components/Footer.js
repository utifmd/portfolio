            ...
            <section id="footer">
				...
				<footer>
					<ul className="icons">
						...
						<li><a href="https://drive.google.com/file/d/1r8dEL90dqTu1fyHmJ4EBHxj0HhvMsYsP/view?usp=sharing" target="_blank" rel="noreferrer" className="icon solid alt fa-external-link-alt"><span className="label">Resume</span></a></li>
					</ul>
				</footer>
			</section>
        )
